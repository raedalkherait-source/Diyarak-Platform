...
- Transport representation and API behavior for operations other than the defined creation, creator direct-loading, creator collection-loading, public published direct-loading, Draft editing, and publication contracts.
