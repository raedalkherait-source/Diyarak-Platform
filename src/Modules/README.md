...
- `Diyarak.Market.Property` — property module with an initial domain baseline covering aggregate identity, supported top-level property categories, required property address, optional geographic location, optional living and usable areas, optional room counts, optional furnishing quality, and optional property features.
