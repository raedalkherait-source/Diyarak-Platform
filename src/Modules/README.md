...
- `Diyarak.Market.Property` — property module with an initial domain baseline covering aggregate identity, supported top-level property categories, required property address, and optional geographic location.
