...
Platform Core contains reusable platform capabilities shared across Diyarak business modules.

Current Platform Core 0.5 structure:

- `Diyarak.Platform.Identity` — baseline identity domain implementation.
- `Diyarak.Platform.Authorization` — foundation scaffold.
- `Diyarak.Platform.ReferenceData` — foundation scaffold.
