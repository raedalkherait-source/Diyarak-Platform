...
- `PostgreSqlMarketPropertyRepository` implements the Application-owned `IMarketPropertyRepository` port for initial Property insertion and no-tracking direct-by-id loading using the existing full-state record mapping.
...
Integrations may persist business Modules and implement Application-owned ports while keeping domain models independent of infrastructure concerns. See ADR-0020, ADR-0021, ADR-0024, ADR-0026, ADR-0027, ADR-0028, ADR-0029, ADR-0030, ADR-0031, ADR-0032, and ADR-0033.
