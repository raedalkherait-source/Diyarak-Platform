...
- `Diyarak.Market.Listing` — initial baseline covered by tests for confirmed publishing-role and transaction-intent value sets, `ListingContext` equality and invalid-value rejection, and `ListingPrice` known/on-request behavior and negative-price rejection.
