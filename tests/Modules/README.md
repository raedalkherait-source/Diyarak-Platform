...
- `Diyarak.Market.Property` — initial domain baseline implemented and covered by tests for aggregate invariants, property address validation and equality, and optional geographic location.
